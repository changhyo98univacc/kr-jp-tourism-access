...
# 지도 채움의 불투명도.
# 검증기는 '불투명한 칠'을 전제로 통과 판정을 낸다. 반투명으로 깔면 밑지도와 섞여
# 실제 화면 색이 달라지고, 합성색으로 다시 재면 기준을 넘지 못한다.
#   opacity 0.80 → 일반시야 ΔE 13.4 (하한 15 미달) · FAIL
#   opacity 0.90 → 14.9 · FAIL
#   opacity 0.95 → 15.6 · PASS
#   opacity 1.00 → 16.3 · PASS  ← 채택
# 지도 경계는 채움이 아니라 얇은 표면색 선으로 나눈다(마크 둘레에 테두리를 두르지 않는다).
MAP_OPACITY = 1.0
MAP_EDGE_W = 0.6
